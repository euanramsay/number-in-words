...
describe('convert numbers to words', () => {
  ...
  it('given 100050 returns one hundred thousand and fifty', () => {
    const input = 100050

    expect(getNumberInWords(input)).toBe('one hundred thousand and fifty')
  })

  it('given 101050 returns one hundred and one thousand and fifty', () => {
    const input = 101050

    expect(getNumberInWords(input)).toBe(
      'one hundred and one thousand and fifty'
    )
  })

  it('given 100050 returns one hundred thousand one hundred and fifty', () => {
    const input = 100150
  ...
  it('given 503231 returns five hundred and three thousand two hundred and thirty one', () => {
    const input = 503231

    expect(getNumberInWords(input)).toBe(
      'five hundred and three thousand two hundred and thirty one'
    )
  })

  it('given 700000 returns seven hundred thousand', () => {
    const input = 700000

    expect(getNumberInWords(input)).toBe('seven hundred thousand')
  })

  it('given 823921 returns eight hundred and twenty three thousand nine hundred and twenty one', () => {
    const input = 823921

    expect(getNumberInWords(input)).toBe(
      'eight hundred and twenty three thousand nine hundred and twenty one'
    )
  })
